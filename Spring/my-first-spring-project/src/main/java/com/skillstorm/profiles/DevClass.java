...
// this bean will ONLY become part of the application context when we're in the dev profile
@Component
@Profile("dev")
// we're implementing CommandLineRunner to run the code in the run() method when this Bean comes to life
public class DevClass implements CommandLineRunner {
    ...
    public void run(String... args) {
        System.out.println("Now utilizing the *** dev *** profile...");
